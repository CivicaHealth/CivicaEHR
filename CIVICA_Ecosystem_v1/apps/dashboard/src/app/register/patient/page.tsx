import { KeyRound, HeartPulse, MessagesSquare } from 'lucide-react';
...
const STEPS = [
  { icon: KeyRound, text: 'Enter the enrollment code your clinic gave you' },
  { icon: HeartPulse, text: 'See the records your care team shares with you' },
  { icon: MessagesSquare, text: 'Message your clinic and request appointments or refills' },
];
    ...
    <main className="flex min-h-screen">
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-[var(--brand-orange)] via-[var(--accent)] to-[var(--navy)] p-12 text-white lg:flex">
        ...
        <div className="max-w-md">
          <h1 className="text-3xl font-semibold tracking-tight">Your health, in one place.</h1>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-8 shadow-lg shadow-slate-200/60">
            ...
            <CardDescription className="mb-6">
              Register with the enrollment code provided by your clinic to access your patient
              portal.
            </CardDescription>
            <PatientRegisterForm />
          </div>
